//
//  DrawModelPopoverBackgroundView.m
//  MxDarwBoard
//
...
@interface DrawModelPopoverBackgroundView()
//用于绘制箭头，如果不绘制，将没有箭头
@property (nonatomic, strong) UIImageView *arrowImageView;

@end

@implementation DrawModelPopoverBackgroundView
...
+ (UIEdgeInsets)contentViewInsets {
    return  UIEdgeInsetsMake(HArrowInsets, HArrowInsets, HArrowInsets,0);
}
